...
export class ListarMisCursosAsignadosComponent implements OnInit {
  ...
  getMisCursos(){
    this.docenteService.getMisCursosAsignados(sessionStorage.getItem('codigoProfesor')).subscribe(response => {
